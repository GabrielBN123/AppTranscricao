...
<div class="container">
    <div class="row py-5 fundo_img">
        <h2 class="mb-1 rounded bg-light py-3" id="form">Formulário</h2>
                    ...
                    <form class="needs-validation" novalidate>
                        <div class="row">
                            <div class="col-md-12 resp_12 col-lg-6 mb-3">
                                ...
                                <textarea class="form-control" id="apre" placeholder="Apresentação" rows="3"></textarea>
                            </div>
                            ...
                            <div class="col-md-12 resp_12 col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="avisos" placeholder="Avisos" rows="3"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12 resp_12 col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="crt_apresentacao" placeholder="Carta de Apresentação" rows="3"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12 resp_12 col-lg-6 mb-2">
                                ...
                                <textarea class="form-control" id="acao_graças" placeholder="Ação de Graças" rows="3" required></textarea>
                            </div>
                            ...
                            <div class="col-md-12 resp_12 col-lg-6 mb-2">
                                ...
                                <textarea class="form-control" id="pedido_oracao" placeholder="Pedido de Oração" rows="3" required></textarea>
                            </div>
                            ...
                            <div class="col-md-12 resp_12 col-lg-6 mb-3">
                                ...
                                <textarea class="form-control" id="apre_RC" placeholder="Apresentação de Recém-Nascidos" rows="3"></textarea>
                            </div>
